...
void SceneManager::Update()
{
	...
	camera.SetEyePt(eyePos + D3DXVECTOR3(cos(D3DXToRadian(player.GetLookCamera())) * 25.0f, 7.0f, sin(D3DXToRadian(player.GetLookCamera())) * 25.0f));
